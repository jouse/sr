...
from utils_stage1 import _gen_training_data_runtime
...
from utils_stage1 import np_REG_batch, search_wav, wav2spec, spec2wav, copy_file, np_batch
...
class Model:
    ...
    def train(self, read_ckpt=None):
        ...
        voice_path = "/Volumes/Transcend 1/AI level2/dataset/speech/*/*"
        dev_voice_path = "/Volumes/Transcend 1/AI level2/dataset/speech/*"
        #noise_path = "/Volumes/Transcend/Download/overall_test/noise/*"
        noise_path = "/Volumes/Transcend 1/AI level2/dataset/noise/*"
        dev_noise_path = "/Volumes/Transcend 1/AI level2/dataset/noise/*"
    ...
    def test(self):
        ...
        with tf.Session() as sess:
            ...
            model_path = './model/_verification/RNN'
